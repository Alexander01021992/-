...
async def create_referral_keyboard(user_id: int, bot_username: str) -> InlineKeyboardMarkup:
    ...
    try:
        ...
        keyboard = [
            [InlineKeyboardButton(text="🎁 Получай 5 фото за друга!", callback_data="ignore")],
            [
                InlineKeyboardButton(
    ...
    try:
        ...
        if is_old_user:
            keyboard.extend([
                ...
                [InlineKeyboardButton(text=available_tariffs["аватар"]["display"], callback_data="pay_690")]
            ])
